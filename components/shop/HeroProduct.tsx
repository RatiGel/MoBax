    ...
    >
      ...
      <div className="absolute inset-x-4 bottom-4 flex items-center justify-between gap-3 rounded-2xl border border-border-light/60 bg-surface-light/90 px-4 py-3 backdrop-blur dark:border-border-dark/60 dark:bg-surface-dark/90">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-cobalt px-4 py-2.5 text-xs font-semibold text-white transition-all hover:bg-cobalt/90 active:scale-[0.97] disabled:opacity-50 motion-reduce:active:scale-100"
        >
